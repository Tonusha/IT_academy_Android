...
public class GetUserByIdUseCaseCW11 extends BaseUseCase {

    private UserRepository userRepository;

    @Inject
    public GetUserByIdUseCaseCW11(PostExecutionThread postExecutionThread, UserRepository userRepository) {
