...
public class UserViewModel extends BaseViewModel {
    ...
    public GetUserByIdUseCase getUserUseCase = new GetUserByIdUseCase(new UIThread(), new UserRepositoryImpl());

    public UserViewModel() {
        progressVisible.set(true);


        getUserUseCase.get("id").subscribe(new Observer<UserEntity>() {
